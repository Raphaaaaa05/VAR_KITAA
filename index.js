    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ 𝚅𝙰𝚁-𝙺𝙸𝚃𝙰𝙰-𝙱𝙾𝚃 is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ 𝚅𝙰𝚁-𝙺𝙸𝚃𝙰𝙰-𝙱𝙾𝚃 Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("𝚅𝙰𝚁-𝙺𝙸𝚃𝙰𝙰-𝙱𝙾𝚃 is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading 𝚅𝙰𝚁-𝙺𝙸𝚃𝙰𝙰-𝙱𝙾𝚃 Commands ...\n");
